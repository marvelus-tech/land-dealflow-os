...
assert.match(html, /styles\.css\?v=phase244-phase263-phase264-phase265-phase266-phase267-phase268-sources-operating-map/, 'index.html must cache-bust Phase 267 Closing trust CSS while preserving prior phase markers.');
