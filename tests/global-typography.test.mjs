...
assert.match(appSource, /<span>Seller sourcing<\/span><b>\$\{specific \? 'buyer-specific' : 'general \+ parallel'\}/, 'Seller sourcing label/status should be short and non-blocking');
...
assert.match(appSource, /Seller sourcing can run now; buy-box detail sharpens the target\./, 'Seller sourcing should use concise non-blocking copy.');
assert.doesNotMatch(appSource, /Locked until the buy box is specific enough to protect seller outreach\.|seller-gate-lock|Specific buy box required\./, 'Noisy visible locked copy should be removed from Builders seller sourcing state');
