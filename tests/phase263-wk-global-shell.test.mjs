...
assert.match(html, /styles\.css\?v=phase244-phase263-phase264-phase265-phase266-today-command/, 'index.html must preserve Phase 263/264 compatibility while cache-busting the later Today command CSS.');
