...
assert.match(html, /styles\.css\?v=phase244-phase263-phase264-phase265-phase266-phase267-phase268-phase269-phase270-phase271-orientation-spine-v3/, 'index.html must preserve Phase 263/264 compatibility while cache-busting the later Closing trust CSS.');
