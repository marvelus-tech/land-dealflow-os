...
assert.match(html, /styles\.css\?v=phase244-phase263-phase264-phase265-phase266-phase267-closing-trust/, 'index.html must cache-bust Phase 267 CSS while preserving older phase guard compatibility.');
