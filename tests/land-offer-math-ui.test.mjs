...
assert.doesNotMatch(app, /send text|send sms|campaign blast/i, 'Offer Math UI must not introduce SMS sending or campaign language.');
...
assert.match(html, /src\/styles\.css\?v=phase240/, 'Index must bust CSS cache for the Phase 240 Offer Math UI.');
