...
import { calculateLandOfferMath } from '../src/core.mjs';

const rankin = calculateLandOfferMath({ parcelId: 'rankin-123', address: '123 Rankin St, Raleigh, NC 27607', acres: 0.25 });
...
assert.match(rankin.sms.compliance, /No texting\/blasting/);
assert.deepEqual(rankin.blockers, []);

const mordecai = calculateLandOfferMath({ zip: '27604', acres: 0.2 });
...
const risk = calculateLandOfferMath({ zip: '27607', acres: 0.25, floodZone: 'yes', slope: 'steep', busyStreet: true, parkNearby: 'no' });
