...
assert.match(html, /styles\.css\?v=phase244-phase263-phase264-phase265-land-command/, 'index.html must cache-bust Phase 265 CSS while preserving older phase guard compatibility.');
