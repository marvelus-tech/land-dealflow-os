...
assert.match(html, /styles\.css\?v=phase244-phase263-wk-global-shell/, 'index.html must cache-bust the Phase 263 CSS while preserving older phase guard compatibility.');
