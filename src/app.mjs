    ...
    <div class="title-desk-grid lower">
      ...
      <article class="title-glass-card title-principles-card">
        ...
        <ul>
          ...
          <li>Closed means funded and disbursed, not merely signed.</li>
        </ul>
      </article>
    </div>
  </section>`;
