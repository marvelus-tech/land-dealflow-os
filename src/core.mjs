...
export function getPermitPortalLandscape() {
  return {
    ...
    leadingMarkets: [
      ...
      { rank: 5, state: 'FL', market: 'Port Charlotte 33948 / Charlotte County', reason: 'Specific ZIP sprint is loaded as buyer-validation candidates; call builders before pulling sellers.', zillowUrl: 'https://www.zillow.com/port-charlotte-fl-33948/' },
      { rank: 6, state: 'FL', market: 'Punta Gorda / Deep Creek 33983', reason: 'Specific Gulf Coast ZIP sprint is loaded; capture max lot price, utilities/access, and absorption before seller sourcing.', zillowUrl: 'https://www.zillow.com/punta-gorda-fl-33983/' },
      { rank: 7, state: 'FL', market: 'Port Charlotte 33953 / NW Charlotte County', reason: 'Specific Charlotte County ZIP sprint is loaded; validate buyer demand before owner enrichment.', zillowUrl: 'https://www.zillow.com/port-charlotte-fl-33953/' },
      { rank: 8, state: 'AZ', market: 'Maricopa / Ak-Chin edge 85139', reason: 'Pinal-edge builder call queue is loaded; verify exact 85139 appetite because regional builders may spill over.', zillowUrl: 'https://www.zillow.com/maricopa-az-85139/' },
      { rank: 9, state: 'AZ', market: 'Mohave Valley / Fort Mohave 86440', reason: 'Colorado River ZIP sprint is loaded; confirm scattered-lot, utilities, and access thresholds.', zillowUrl: 'https://www.zillow.com/mohave-valley-az-86440/' },
      { rank: 10, state: 'HI', market: 'Puna / East Hawaii ZIPs 96749, 96778, 96771', reason: 'Big Island builder queue is loaded; validate lava/flood/access deal killers before seller work.', zillowUrl: 'https://www.zillow.com/hawaii-county-hi/' },
      { rank: 11, state: 'NV', market: 'Pahrump 89048 / Nye County', reason: 'Desert-lot builder queue is loaded; capture well/septic/power/road requirements.', zillowUrl: 'https://www.zillow.com/pahrump-nv-89048/' },
      { rank: 12, state: 'CA', market: 'Joshua Tree 92252 / San Bernardino County', reason: 'Hi-desert custom-builder queue is loaded; validate water, access, STR, and entitlement constraints.', zillowUrl: 'https://www.zillow.com/joshua-tree-ca-92252/' },
      { rank: 13, state: 'NC', market: 'Charlotte / Mecklenburg → Wake → Guilford corridor', reason: 'Buildchek + Accela + Power BI/ArcGIS data; strong Piedmont land-flipping corridor.', zillowUrl: 'https://www.zillow.com/charlotte-nc/' },
      { rank: 14, state: 'TX', market: 'Austin / San Antonio open-data corridor', reason: 'Socrata/open data gives programmatic permit intake before fragmented Houston/Dallas work; PermitVector covers normalized paid expansion.', zillowUrl: 'https://www.zillow.com/austin-tx/' },
      { rank: 15, state: 'OH', market: 'Columbus / Franklin County', reason: 'City of Columbus ArcGIS building-permit layer now exposes source-backed residential permit applicants for buyer validation.', zillowUrl: 'https://www.zillow.com/columbus-oh/' },
