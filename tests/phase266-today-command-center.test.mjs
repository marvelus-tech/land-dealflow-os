...
assert.match(html, /styles\.css\?v=phase244-phase263-phase264-phase265-phase266-today-command/, 'index.html must cache-bust Phase 266 Today command CSS while preserving prior phase markers.');
