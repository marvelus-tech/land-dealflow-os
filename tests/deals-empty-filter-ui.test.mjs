...
assert.match(readFileSync('index.html', 'utf8'), /src\/styles\.css\?v=phase240/, 'Index must bust CSS cache through the latest Land Offer Math pass while preserving empty inspector parity.');
