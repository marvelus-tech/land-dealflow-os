...
assert.match(html, /styles\.css\?v=phase244-phase263-phase264-builders-command/, 'index.html must cache-bust Phase 264 CSS while preserving older phase guard compatibility.');
