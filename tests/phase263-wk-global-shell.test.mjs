...
assert.match(html, /styles\.css\?v=phase244-phase263-phase264-phase265-land-command/, 'index.html must preserve Phase 263/264 compatibility while cache-busting the later Land command CSS.');
